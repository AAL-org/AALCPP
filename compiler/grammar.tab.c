...
{
  "$end", "error", "$undefined", "FUNCTION", "NAME", "LEFT_BRACKET",
  "RIGHT_BRACKET", "LEFT_BRACE", "RIGHT_BRACE", "HEXADECIMAL_INTEGER",
  "OCTAL_INTEGER", "DENARY_INTEGER", "BINARY_INTEGER", "DENARY_FLOAT",
  "COLON", "SEMICOLON", "$accept", "input", "statements", "statement",
  "name", YY_NULLPTR
};
#endif
...
{
       9,     1,     4,     3,    10,     5,    13,     6,     0,     0,
       7
};

static const yytype_int8 yycheck[] =
{
       4,     3,     0,     4,     8,     5,    15,     6,    -1,    -1,
       7
};
